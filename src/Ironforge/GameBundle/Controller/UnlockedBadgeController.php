...
class UnlockedBadgeController extends Controller
{
    ...
    {
        $badgeRepository = $this->get('ironforge.game.repository.badge');
    ...
    public function deleteAction(Request $request)
    {
        ...
        if ('POST' === $request->getMethod()) {
            ...
            $unlockedBadge = $this->get('ironforge.game.repository.unlocked_badge')
                ->findOneBy([
                    'user' => $user,
                    'badge' => $badge
                ]);
            ...
            $unlockedBadgeRemover = $this->get('ironforge.game.remover.unlocked_badge');
