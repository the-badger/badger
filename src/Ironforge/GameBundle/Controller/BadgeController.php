...
use Ironforge\GameBundle\Form\BadgeType;
...
class BadgeController extends Controller
{
    ...
    {
        $badges = $this->get('ironforge.game.repository.badge')
            ->findAll();
    ...
    {
        $badgeFactory = $this->get('ironforge.game.badge.factory');
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            ...
            $badgeSaver = $this->get('ironforge.game.saver.badge');
    ...
    public function deleteAction(Request $request, Badge $badge)
    {
        ...
        if ($form->isSubmitted() && $form->isValid()) {
            $badgeRemover = $this->get('ironforge.game.remover.badge');
     ...
     *
     * @param Badge $game The Badge entity
     *
     * @return Form The form
     */
    private function createDeleteForm(Badge $game)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_badge_delete', ['id' => $game->getId()]))
            ->setMethod('DELETE')
            ->getForm()
        ;
    }
